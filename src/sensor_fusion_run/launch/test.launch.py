...
def generate_launch_description():
    ...
    runtime_profile_csv = LaunchConfiguration('runtime_profile_csv')
    ...
    return LaunchDescription([
        DeclareLaunchArgument(
            'runtime_profile_csv',
            default_value='',
            description='Optional CSV path for live runtime profiling samples.',
        ),
        ...
        Node(
            ...
            parameters=[{
                ...
                'show_window': True,
                'runtime_profile_csv': runtime_profile_csv,
                'use_sim_time': True,
            }],
        ),
        ...
        Node(
            ...
            executable='static_transform_publisher',
            output='screen',
            arguments=['0', '0', '1.075', '0', '0.28', '0', 'base_footprint', 'camera_link'],
            parameters=[{'use_sim_time': True}],
        ),
