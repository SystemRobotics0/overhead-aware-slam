...
class ObjectDetector2(Node):
    ...
    def listener_callback(self, msg: Image):
        ...
        self.profiler.record_many({
            "detector_image_decode": (t_decode - t_total) * 1000.0,
            "detector_preprocess": (t_preprocess - t_decode) * 1000.0,
            "detector_inference": (t_inference - t_preprocess) * 1000.0,
            "detector_postprocess_publish": (t_postprocess - t_inference) * 1000.0,
            "detector_display": (t_end - t_postprocess) * 1000.0,
            "total_detector_callback": (t_end - t_total) * 1000.0,
